          ...
          >
            <div className="space-y-2">
              <div className="flex gap-2 text-pink-soft/60">
                <span>[sistema]</span>
                <Typewriter 
                  text="Descifrando sentimientos para Gabby..."
                  delay={30} 
              ...
              {consoleFinished && (
                ...
                >
                  <p className="text-white/40 italic">
                    {">"} Se encontró un mensaje especial para Gabby.
                  </p>
                  ...
                  >
                    ...
                    <span className="font-mono tracking-widest uppercase text-xs">Abre mi corazon</span>
                    <span className="terminal-cursor" />
                  </button>
                  
                  <p className="text-[10px] text-white/20 animate-pulse">
                    (o toca cualquier parte de la pantalla)
                  </p>
                </motion.div>
              )}
            </div>
